...
namespace RTSEngine
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public class FactionInfo
        {
            ...
            public NPCManager npcMgrIns; //the active instance of the NPC manager prefab.
        ...
        public int activeFactionsAmount = 0; //Amount of spawned factions;
        ...
        public bool InitMultiplayerGame ()
        {
        ...
        public bool InitSinglePlayerGame ()
        {
        ...
        public bool SetPlayerFactionID()
        {
            PlayerFactionID = -1;
            for (int i = 0; i < Factions.Count; i++) //go through the factions list
            {
        ...
        public void InitFactionCapitals ()
        {
        ...
        public void RandomizePlayerFaction()
        {
