...
namespace RTSEngine
{
    public class NPCBuildingConstructor : NPCComponent
    {
        ...
        public NPCUnitRegulator builderRegulatorIns; //the active instance of the builder regulator.

        public List<Building> buildingsToConstruct = new List<Building>(); //holds a list of the faction buildings that need construction.
        ...
        public bool isActive = false; //is this component active?
