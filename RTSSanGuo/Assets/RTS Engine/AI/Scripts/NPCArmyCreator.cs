...
namespace RTSEngine
{
    public class NPCArmyCreator : NPCComponent
    {
        ...
        public List<NPCUnitRegulator> armyUnitRegulatorIns = new List<NPCUnitRegulator>();
        ...
        public float forceCreationTimer;

        public bool isActive = false; //is the component active?
