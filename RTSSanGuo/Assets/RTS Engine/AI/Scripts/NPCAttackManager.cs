...
namespace RTSEngine
{
    public class NPCAttackManager : NPCComponent
    {
        ...
        public float setTargetFactionTimer;
        public FactionManager targetFaction; //the faction manager component of the target faction.

        //launching the attack:
        public bool isAttacking = false; //is the faction currently in an attack?
        ...
        public float launchAttackTimer;
        ...
        public Vector3 lastAttackPos; //the last position of the target building in the attack
        //list of units that will participate in the attack:
        public List<Unit> currentAttackUnits = new List<Unit>();
        ...
        public List<string> targetBuildingCodes = new List<string>(); //codes of the above buildings will be saved here.
        public Building currentTargetBuilding; //the current building that this faction is attempting to destroy.
