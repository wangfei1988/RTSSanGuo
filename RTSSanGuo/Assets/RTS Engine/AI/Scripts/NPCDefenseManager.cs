...
namespace RTSEngine
{
    ...
    {
        public bool isDefending = false; //is the faction currently in defense mode?
        ...
        public float cancelDefenseTimer;

        public Building lastDefenseCenter; //the last defense center is saved here.
