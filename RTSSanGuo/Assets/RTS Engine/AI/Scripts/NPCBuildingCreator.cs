...
namespace RTSEngine
{
    public class NPCBuildingCreator : NPCComponent
    {
        ...
        public List<BuildingCenterRegulator> buildingCenterRegulators = new List<BuildingCenterRegulator>(); //a list that holds building centers and their corresponding active building regulators
