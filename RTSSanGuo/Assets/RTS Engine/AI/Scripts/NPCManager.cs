...
namespace RTSEngine
{
    public class NPCManager : MonoBehaviour
    {
        ...
        //NPC Components:
        public NPCBuildingCreator buildingCreator_NPC { get;  set; }
        public NPCBuildingPlacer buildingPlacer_NPC { get;  set; }
        public NPCBuildingConstructor buildingConstructor_NPC { get;  set; }

        public NPCUnitCreator unitCreator_NPC { get;  set; }

        public NPCResourceManager resourceManager_NPC { get;  set; }
        public NPCResourceCollector resourceCollector_NPC { get;  set; }
        public NPCTerritoryManager territoryManager_NPC { get;  set; }

        public NPCPopulationManager populationManager_NPC { get;  set; }

        public NPCTaskManager taskManager_NPC { get; set; }

        public NPCAttackManager attackManager_NPC { get; set; }
        public NPCArmyCreator armyCreator_NPC { get; set; }
        public NPCDefenseManager defenseManager_NPC { get; set; }
