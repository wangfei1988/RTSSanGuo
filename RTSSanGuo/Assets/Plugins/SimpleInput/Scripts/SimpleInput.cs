...
{
	public enum InputState { None, Pressed, Held, Released };
	...
	public const float AXIS_LERP_MODIFIER = 20f;

	// Singleton instance
	public static SimpleInput instance;

	public static Dictionary<string, Axis> axes = new Dictionary<string, Axis>();
	public static List<Axis> axesList = new List<Axis>();

	public static List<AxisInput> trackedUnityAxes = new List<AxisInput>();
	public static List<AxisInput> trackedTemporaryAxes = new List<AxisInput>();
	...
	public static List<ButtonInput> trackedUnityButtons = new List<ButtonInput>();
	public static List<ButtonInput> trackedTemporaryButtons = new List<ButtonInput>();

	public static Dictionary<int, MouseButton> mouseButtons = new Dictionary<int, MouseButton>();
	public static List<MouseButton> mouseButtonsList = new List<MouseButton>();

	public static List<MouseButtonInput> trackedUnityMouseButtons = new List<MouseButtonInput>();
	public static List<MouseButtonInput> trackedTemporaryMouseButtons = new List<MouseButtonInput>();

	public static Dictionary<KeyCode, Key> keys = new Dictionary<KeyCode, Key>();
	public static List<Key> keysList = new List<Key>();
	...
	public static void OnSceneChanged( Scene scene, LoadSceneMode loadSceneMode )
	{
	...
	public static void RegisterAxis( AxisInput input )
	{
		Axis axisObj;
	...
	public static void UnregisterAxis( AxisInput input )
	{
		Axis axisObj;
		if( axes.TryGetValue( input.Key, out axisObj ) )
		{
	...
	public static void RegisterButton( ButtonInput input )
	{
		Button buttonObj;
	...
	public static void UnregisterButton( ButtonInput input )
	{
		Button buttonObj;
		if( buttons.TryGetValue( input.Key, out buttonObj ) )
		{
	...
	public static void RegisterMouseButton( MouseButtonInput input )
	{
	...
	public static void UnregisterMouseButton( MouseButtonInput input )
	{
		MouseButton mouseButtonObj;
		if( mouseButtons.TryGetValue( input.Key, out mouseButtonObj ) )
		{
	...
	public static void RegisterKey( KeyInput input )
	{
		Key keyObj;
	...
	public static void UnregisterKey( KeyInput input )
	{
		Key keyObj;
		if( keys.TryGetValue( input.Key, out keyObj ) )
		{
	...
	public static void TrackAxis( string axis, bool trackUnityAxisOnly = false )
	{
		try
		{
	...
	public static void TrackButton( string button, bool trackUnityButtonOnly = false )
	{
		try
		{
	...
	public static void TrackMouseButton( int button, bool trackUnityMouseButtonOnly = false )
	{
		try
		{
