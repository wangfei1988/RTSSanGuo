...
{
	public class ButtonClickInput : SimpleInput.ButtonInput
	{
	...
	public class MouseButtonClickInput : SimpleInput.MouseButtonInput
	{
	...
	public class KeyClickInput : SimpleInput.KeyInput
	{
